...
# ERCO DEBLURRING PARAMETERS
N_SUBBANDS = 15

# DATASETS
DATASETS = ['blurred', 'deblurred_pmp3_lambda0', 'deblurred_pmp3', 'deblurred_nb3', 'deblurred_nb_ls_adhoc',
            'deblurred_erco'
            ]
...
CONDITIONS = [0, 1, 3, 5, 7, 10, 15, 'global']
COLOR_PALETTE_SNS = 'colorblind'

PALETTE = {
    'blurred': 'C0',
    'deblurred_pmp3_lambda0': 'C1',
    'deblurred_pmp3': 'C2',
    'deblurred_nb3': 'C3',
    'deblurred_nb_ls_adhoc': 'C4',
    'human': 'C5',
    "deblurred_erco": '#377eb8',
}

DATASETS_DICT = {
    'original': 'Latent image',
    'blurred': 'Blurred observations',
    'deblurred_nb3': 'Non-Blind HL',
    'deblurred_pmp3_lambda0': 'Blind L0',
    'deblurred_pmp3': 'Blind PMP',
    'humans': 'Humans',
    'deblurred_nb_ls_adhoc': 'Non-Blind LS',
    'deblurred_erco': 'ERCO (Ours)',
}

CONDITION_IMAGE_MAPPING = {
    1: '0524_lp_dnn_1_bottle_10_n02823428_8280.png',
    3: '1189_lp_dnn_3_car_10_n04285008_3410.png',
    5: '0294_lp_dnn_5_bear_10_n02133161_1490.png',
    7: '0664_lp_dnn_7_chair_10_n03376595_11572.png',
    10: '0320_lp_dnn_10_dog_10_n02101006_15350.png',
    15: '0087_lp_dnn_15_oven_10_n04111531_8793.png',
}
...
imagenet_classes = ["tench", "goldfish", "great white shark", "tiger shark", "hammerhead shark", "electric ray",
                    ...
                    "ring-necked snake", "eastern hog-nosed snake", "smooth green snake", "kingsnake",
                    ...
                    "eastern diamondback rattlesnake", "sidewinder rattlesnake", "trilobite", "harvestman",
                    ...
                    "ptarmigan", "ruffed grouse", "prairie grouse", "peafowl", "quail", "partridge",
                    ...
                    "dunlin", "common redshank", "dowitcher", "oystercatcher", "pelican", "king penguin", "albatross",
                    ...
                    "Groenendael dog", "Malinois", "Briard", "Australian Kelpie", "Komondor", "Old English Sheepdog",
                    "Shetland Sheepdog", "collie", "Border Collie", "Bouvier des Flandres dog", "Rottweiler",
                    "German Shepherd Dog", "Dobermann", "Miniature Pinscher", "Greater Swiss Mountain Dog",
                    "Bernese Mountain Dog", "Appenzeller Sennenhund", "Entlebucher Sennenhund", "Boxer",
                    "Bullmastiff", "Tibetan Mastiff", "French Bulldog", "Great Dane", "St. Bernard", "husky",
                    "Alaskan Malamute", "Siberian Husky", "Dalmatian", "Affenpinscher", "Basenji", "pug", "Leonberger",
                    "Newfoundland dog", "Great Pyrenees dog", "Samoyed", "Pomeranian", "Chow Chow", "Keeshond",
                    ...
                    "dung beetle", "rhinoceros beetle", "weevil", "fly", "bee", "ant", "grasshopper", "cricket insect",
                    ...
                    "marimba", "mask", "matchstick", "maypole", "maze", "measuring cup", "medicine cabinet", "megalith",
                    "microphone", "microwave oven", "military uniform", "milk can", "minibus", "miniskirt", "minivan",
                    "missile", "mitten", "mixing bowl", "mobile home", "ford model t", "modem", "monastery", "monitor",
                    "moped", "mortar and pestle", "graduation cap", "mosque", "mosquito net", "vespa", "mountain bike",
                    "tent", "computer mouse", "mousetrap", "moving van", "muzzle", "metal nail", "neck brace",
                    "necklace", "baby pacifier", "notebook computer", "obelisk", "oboe", "ocarina", "odometer",
                    "oil filter", "pipe organ", "oscilloscope", "overskirt", "bullock cart", "oxygen mask",
                    ...
                    "piggy bank", "pill bottle", "pillow", "ping-pong ball", "pinwheel", "pirate ship", "drink pitcher",
                    ...
                    "throne", "tile roof", "toaster", "tobacco shop", "toilet seat", "torch", "totem pole", "tow truck",
                    "toy store", "tractor", "semi-trailer truck", "tray", "trench coat", "tricycle", "trimaran",
                    "tripod", "triumphal arch", "trolleybus", "trombone", "hot tub", "turnstile", "typewriter keyboard",
                    "umbrella", "unicycle", "upright piano", "vacuum cleaner", "vase", "vaulted or arched ceiling",
                    "velvet fabric", "vending machine", "vestment", "viaduct", "violin", "volleyball", "waffle iron",
                    "wall clock", "wallet", "wardrobe", "military aircraft", "sink", "washing machine", "water bottle",
                    "water jug", "water tower", "whiskey jug", "whistle", "hair wig", "window screen", "window shade",
                    "Windsor tie", "wine bottle", "airplane wing", "wok", "wooden spoon", "wool", "split-rail fence",
                    "shipwreck", "sailboat", "yurt", "website", "comic book", "crossword", "traffic or street sign",
                    "traffic light", "dust jacket", "menu", "plate", "guacamole", "consomme", "hot pot", "trifle",
                    ...
                    "cherimoya (custard apple)", "pomegranate", "hay", "carbonara", "chocolate syrup", "dough",
                    "meatloaf", "pizza", "pot pie", "burrito", "red wine", "espresso", "tea cup", "eggnog", "mountain",
                    "bubble", "cliff", "coral reef", "geyser", "lakeshore", "promontory", "sandbar", "beach", "valley",
                    "volcano", "baseball player", "bridegroom", "scuba diver", "rapeseed", "daisy",
                    "yellow lady's slipper", "corn", "acorn", "rose hip", "horse chestnut seed", "coral fungus",
                    "agaric", "gyromitra", "stinkhorn mushroom", "earth star fungus", "hen of the woods mushroom",
                    "bolete", "corn cob", "toilet paper"]

imagenet_templates = ['a bad photo of a {}.', 'a photo of many {}.', 'a sculpture of a {}.',
...
NRIQA_METRICS = ['brisque', 'niqe', 'nima-vgg16-ava', 'cnniqa', 'dbcnn', 'paq2piq', 'hyperiqa', 'nima', 'topiq_nr',
                 'topiq_nr-flive', 'topiq_nr-spaq', 'clipiqa', 'clipiqa+', 'clipiqa+_vitL14_512',
                 'clipiqa+_rn50_512', 'musiq', 'musiq-spaq', 'musiq-paq2piq', 'musiq-ava', 'tres', 'maniqa',
                 'ilniqe', 'pi', 'nrqm', 'tres-flive', 'maniqa-kadid', 'maniqa-pipal', 'sseq']

FRIQA_METRICS = ['topiq_fr', 'topiq_fr-pipal', 'ahiq', 'pieapp', 'lpips', 'lpips-vgg', 'stlpips', 'stlpips-vgg',
                 'dists', 'ckdn', 'fsim', 'ssim', 'ms_ssim', 'cw_ssim', 'psnr', 'vif', 'gmsd', 'nlpd', 'vsi', 'mad']

SELECTED_FRIQA_METRICS = ['psnr', 'ssim', 'dists', 'lpips']
SELECTED_NRIQA_METRICS = ['brisque', 'niqe', 'nima', 'sseq']

##################################################################
# MODELS
##################################################################

TORCHVISION_MODELS = ['alexnet', 'vgg11_bn', 'vgg13_bn', 'vgg16_bn', 'vgg19_bn', 'squeezenet1_0', 'squeezenet1_1',
                      'densenet121', 'densenet169', 'densenet201', 'inception_v3', 'resnet18', 'resnet34',
                      'resnet50', 'resnet101', 'resnet152', 'shufflenet_v2_x0_5', 'mobilenet_v2', 'resnext50_32x4d',
                      'resnext101_32x8d', 'wide_resnet50_2', 'wide_resnet101_2', 'mnasnet0_5', 'mnasnet1_0']

BAGNET_MODELS = ['bagnet9', 'bagnet17', 'bagnet33']

SHAPENET_MODELS = ['resnet50_trained_on_SIN', 'resnet50_trained_on_SIN_and_IN',
...
EFFICIENTNET_MODELS = ['efficientnet_b0', 'efficientnet_b0_noisy_student']

ADV_ROBUST_MODELS = ['resnet50_l2_eps0', 'resnet50_l2_eps0_5', 'resnet50_l2_eps1', 'resnet50_l2_eps3',
                     'resnet50_l2_eps5']

VISION_TRANSFORMER_MODELS = ['vit_small_patch16_224', 'vit_base_patch16_224', 'vit_large_patch16_224']
...
BEST_MODELS = VISION_TRANSFORMER_MODELS + BIT_M_MODELS + SWAG_MODELS


ALL_MODELS = TORCHVISION_MODELS + BAGNET_MODELS + SHAPENET_MODELS + SIMCLR_MODELS + PYCONTRAST_MODELS + \
             EFFICIENTNET_MODELS + ADV_ROBUST_MODELS + VISION_TRANSFORMER_MODELS + BIT_M_MODELS + SWAG_MODELS
