...
from ..wrappers.pytorch import PyContrastPytorchModel
from ..wrappers.pytorch import ViTPytorchModel
from ..wrappers.pytorch import SwagPytorchModel
...
def efficientnet_b0_noisy_student(model_name, *args):
    model = torch.hub.load(_PYTORCH_IMAGE_MODELS,  'tf_efficientnet_b0_ns', pretrained=True)
    return PytorchModel(model, model_name, *args)
...
def BiTM_resnetv2_50x1(model_name, *args):
    model = torch.hub.load(_PYTORCH_IMAGE_MODELS, 'resnetv2_50x1_bitm', pretrained=True)
    return PytorchModel(model, model_name, *args)


@register_model('pytorch')
def BiTM_resnetv2_50x3(model_name, *args):
    model = torch.hub.load(_PYTORCH_IMAGE_MODELS, 'resnetv2_50x3_bitm', pretrained=True)
    return PytorchModel(model, model_name, *args)


@register_model('pytorch')
def BiTM_resnetv2_101x1(model_name, *args):
    model = torch.hub.load(_PYTORCH_IMAGE_MODELS, 'resnetv2_101x1_bitm', pretrained=True)
    return PytorchModel(model, model_name, *args)


@register_model('pytorch')
def BiTM_resnetv2_101x3(model_name, *args):
    model = torch.hub.load(_PYTORCH_IMAGE_MODELS, 'resnetv2_101x3_bitm', pretrained=True)
    return PytorchModel(model, model_name, *args)


@register_model('pytorch')
def BiTM_resnetv2_152x2(model_name, *args):
    model = torch.hub.load(_PYTORCH_IMAGE_MODELS, 'resnetv2_152x2_bitm', pretrained=True)
    return PytorchModel(model, model_name, *args)


@register_model('pytorch')
def BiTM_resnetv2_152x4(model_name, *args):
    model = torch.hub.load(_PYTORCH_IMAGE_MODELS, 'resnetv2_152x4_bitm', pretrained=True)
    return PytorchModel(model, model_name, *args)
